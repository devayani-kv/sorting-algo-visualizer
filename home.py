...
def Generate():
    ...
    drawData(data, ['orange' for x in range(len(data))]) #['red', 'red' ,....]
...
speedScale = Scale(UI_frame, from_=0.001, to=2.0, length=200, digits=4, resolution=0.001, orient=HORIZONTAL, label="Select Speed [s]")
